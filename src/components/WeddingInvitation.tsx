...
function ViberIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path
        d="M12 2C6.5 2 2 6 2 11c0 2.4.9 4.6 2.5 6.2L3 21l3.9-1.3C8.4 20.5 10.1 21 12 21c5.5 0 10-4 10-9s-4.5-10-10-10z"
        fill="currentColor"
      />
      <path
        d="M9 8.5c.2.8.5 1.5.9 2.2l.7-.7c.2-.2.5-.3.7-.1.4.3.8.5 1.3.7.3.1.4.4.3.7l-.4 1.2c-.1.3-.4.5-.7.4C9.5 13 7 10.5 7 7.8c0-.3.2-.6.4-.7l1.2-.4c.3-.1.6.1.7.3.2.5.4 1 .7 1.3.2.2.1.5-.1.7l-.7.7c.2.4.5.8.8.8z"
        fill="#7360F2"
      />
      <path
        d="M14.7 6.4c1.4.4 2.5 1.5 2.9 2.9M14.2 8.3c.8.2 1.4.8 1.6 1.6"
        stroke="#7360F2"
        strokeLinecap="round"
        strokeWidth="1.2"
      />
